...
class TenMinutesPage extends StatefulWidget {
  @override
  _TenMinutesPageState createState() => _TenMinutesPageState();
}

class _TenMinutesPageState extends State<TenMinutesPage> {
